...
void print(std::ostream& O, char space = ' ') const { dlist::print(O,space); }
...
/*
friend void Print(const list<E>& L, std::ostream& out) { L.print(out); }
friend void Read(list<E>& L, std::istream& in)         { L.read(in); }
*/
